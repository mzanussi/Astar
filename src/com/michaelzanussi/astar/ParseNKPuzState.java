...
public class ParseNKPuzState {
	...
	public static List<Object> parse(Lexer lexer) throws ParsingException {
		
		List<Object> nkPuzState = new ArrayList<Object>();
		...
		// ...is it a number list?
			...
			while (true) {
				...
				List<Integer> numList = ParseNumList.parse(lexer);
		...
		// Illegal token.
			...
			throw new ParsingException("ParseMCState.parse error: Expected '[', ',' or a number list but received '" + token.getToken() + "'.");
		}
